...
from app.ml.feature_engineering.constants import EDUCATION_LEVELS
...
class EligibilityService:
    ...
    def _check_education(self, candidate: CandidateProfile, criteria: dict[str, Any]) -> bool:
        ...
        candidate_level = EDUCATION_LEVELS.get(candidate_degree, 0)
        required_level = EDUCATION_LEVELS.get(min_education.lower(), 0)
