...
function CountdownTimer({ deadline }: { deadline: string }) {
  ...
  if (isExpired) {
    return <span className="text-sm text-gov-error font-medium">Deadline passed</span>;
  }
    ...
    <div className="flex gap-2">
      {[
        ...
        <div key={unit.label} className="text-center">
          <div className="bg-navy-500 text-white rounded-lg px-2.5 py-1.5 min-w-[40px]">
            <span className="text-lg font-bold">{String(unit.value).padStart(2, "0")}</span>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm font-medium">{formatCurrency(offer.stipend)}/mo</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm font-medium">{offer.duration} months</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
...
export default function OffersPage() {
  ...
  const tabs = [
    {
      id: "active",
      label: `Active Offers (${activeOffers.filter((o) => o.status === "pending").length})`,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-gov-success">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-gov-error">
